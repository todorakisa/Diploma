 ...
 */
final class Version20190227175640 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE participants_events (event_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_9E6008D871F7E88B (event_id), INDEX IDX_9E6008D8A76ED395 (user_id), PRIMARY KEY(event_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
